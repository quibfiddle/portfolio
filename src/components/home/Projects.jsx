  ...
  return (
    <Container id="projects">
        ...
        <Tab eventKey="rpa" title="Robotic Process Automation">
            <Container>
                <Row className="align-items-center fixed-height-row">
                    <Col md={4} className="d-flex justify-content-center align-items-center"><Image src="images/soundstrue.webp" fluid></Image></Col>
                    <Col md={8}><h3>Sounds True Online Course Migration</h3><span>For this project, I worked with stakeholders to understand and develop a RPA tool to extract the entire Course Library from their previous e-learning platform and load it into their current one. With the tool, we were able to perform ETL on over 150 courses, each of which had 10 - 100 pages and videos associated with them. The tool has since been used to perform similar migrations on several other e-learning platforms such as <a href="https://psycharmor.org/">PsychArmor</a>, <a href="https://www.functionalmovement.com">Functional Movement</a> and <a href="https://www.golearn.dk/">GoLearn</a></span></Col>
                </Row>
                <Row className="align-items-center fixed-height-row">
                    <Col md={4} className="d-flex justify-content-center align-items-center"><Image src="images/dhs.png" fluid></Image></Col>
                    <Col md={8}><h3>Department of Homeland Security Acquisition Program Baseline Cataloging</h3><span>DHS Manages projects through the use of Acquisition Program Baseline (APBs) documents to measure program cost, schedule and performance. The documents themselves however, were often PDFs that had been printed, written on, scanned and saved again. In this project, using UiPath, I demonstrated our ability to iterate through a provided set of such documents, use computer vision to extract the text contents of those documents, and store metadata in a database about each APB, such as name, budget, expected completion ect.</span></Col>
                </Row>
            </Container>
        </Tab>
        ...
        <Tab eventKey="it" title="IT">
            <Container>
                <Row className="align-items-center fixed-height-row">
                    <Col md={4} className="d-flex justify-content-center align-items-center"><Image src="images/AVGtoBitdefender.png" fluid></Image></Col>
